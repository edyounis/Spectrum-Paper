...
Spectre and Meltdown style attacks have been classified by Intel \cite{b54}, ARM \cite{b16}, and AMD \cite{b53} CPU Manufacturers. These classifications only consider the attacks that effect their processors. Our taxonomony differs most from these because we stay agnostic to vendor. 

Additionally, these recommend a solution which is known to work without consideration to scope. This leaves the analysis of the defenses limited in software.
