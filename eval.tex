...
Overall, the attacks were able to be replicated on the BOOM microarchitecture. A printout
of the Bounds Check Bypass attack is shown in \ref{ref:spec-attack-printout}. Additionally,
results of the replications are promising with \ref{tab:spec-attack-results}
...
and the extra arithmetic in the Branch Target Injection case where you have to calculate
