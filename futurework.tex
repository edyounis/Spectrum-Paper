...
\subsubsection{BOOM-oriented Cache}
...
Finally, the cache is strictly single ported, and does not perform optimizations such as store coalescing. In order to investigate higher performance variants of the BOOM core, a high performance multi-ported data cache will be required.
...
our proof-of-concept, we may be better served by investigating a re-architecting of BOOM's data cache with speculative safety in mind. This builds upon our other thoughts
...
BOOM is currently configured with an L1 data cache and a large scratchpad memory in lieu of an L2.
